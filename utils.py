...
def set_up():
    ...
    # else:
    config = {
        "DOMAIN": os.getenv("DOMAIN", "localhost:44310"),
        "API_AUDIENCE": os.getenv("API_AUDIENCE", "PortalApi"),
        "ISSUER": os.getenv("ISSUER", "http://localhost:44310"),
...
class VerifyToken():
    ...
    def __init__(self, token, permissions=None, scopes=None):
        ...
        jwks_url = f'http://{self.config["DOMAIN"]}/.well-known/openid-configuration/jwks'
